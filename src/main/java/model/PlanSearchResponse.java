...
public class PlanSearchResponse  implements Serializable {
  ...
  @JsonProperty("plans")
  private List<ACAPlan> plans = new ArrayList<ACAPlan>();
  ...
  **/
  ...
  public PlanSearchResponse plans(List<ACAPlan> plans) {
    this.plans = plans;
    return this;
  }

  public PlanSearchResponse addPlansItem(ACAPlan plansItem) {
  ...
  **/
  ...
  public List<ACAPlan> getPlans() {
    return plans;
  }

  public void setPlans(List<ACAPlan> plans) {
    this.plans = plans;
  }
