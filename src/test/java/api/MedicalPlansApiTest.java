...
/**
 * API tests for MedicalPlansApi
 */
public class MedicalPlansApiTest {

    private MedicalPlansApi api;

    @Before
    public void setup() {
        api = new ApiClient().buildClient(MedicalPlansApi.class);
    }
    ...
    public void showPlanTest() {
        String id = null;
        Integer year = null;
        // PlanShowResponse response = api.showPlan(id, year);
